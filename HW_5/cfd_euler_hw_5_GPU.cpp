...
// ------------------------------------------------------------
// Device Functions (Must be declared for GPU execution)
// ------------------------------------------------------------
...
int main(){
    ...
    cout << "Initializing simulation with Grid Size: " << Nx << " x " << Ny << endl;
    ...
    // Changed to int* for safer OpenMP target mapping across compilers
    ...
    // Mapping explicit array lengths because we are using raw malloc pointers
    ...
    ofstream outFile("HW_5_results_GPU.txt", ios::app);
